                      ...
                      return _searchResult.length != 0 ||
                        ...
                        itemBuilder: (_,index)
                        {
                         return Material(
                            ...
                            //  Networking.getAllTopic("BCA", "1", "Physics", "1");
                             Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>MobileTopic(
                                  ...
                                  unit : _searchResult[index].unit.toString(),
                                  pdfName: _searchResult[index].pdfName,
                                  pdfUrl: _searchResult[index].pdfUrl,
                                ),),).then((_){
                           ...
                           child: MobileContainer(course: _searchResult[index].unit.toString()),
        ...
        child: TextField(
          ...
          onChanged: (value) async {
           if(specificUnit.isNotEmpty)
           {
            ...
            setState(() {
            specificUnit[0].courses.semesters.subjects.units.forEach((searchValue) {
              if (searchValue.unit.toString().toLowerCase().contains(value.toLowerCase())) {  
